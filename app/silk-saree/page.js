...
export default function SilkSareePage() {
  const silkSarees = [
    { id: 1, name: "Royal Silk Saree", price: "₹15,000", image: "/image1.jpg" },
    { id: 2, name: "Elegant Silk Saree", price: "₹12,000", image: "/image1.jpg" },
    { id: 3, name: "Traditional Silk Saree", price: "₹18,000", image: "/image1.jpg" },
    { id: 4, name: "Designer Silk Saree", price: "₹20,000", image: "/image1.jpg" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Discover our premium silk saree collection crafted with the finest materials and traditional techniques
          </p>
        </div>
